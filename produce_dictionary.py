...
produce_data = pd.DataFrame(produce_dictionary)
produce_data.index = ['Cost Per Pound', 'Quantity Sold', 'Total Sales']
produce_data = produce_data.T

print("------------------------------------------------------------STEP 1--------------------------------------------------------")
print('Produce that had the highest and lowest sales in total sales (both name of produce and value)')
print()
print('Max: ',  produce_data['Total Sales'].idxmax(), '-', produce_data['Total Sales'].max())
print('Min: ', produce_data['Total Sales'].idxmin(), '-', produce_data['Total Sales'].min())
print()
